...
const EditCompany = ({setAuth, category_id, category_name, company_id, title, logo, top_img, city, location, site, site_link, schedule, phone, route, about}) => {
...
const validationSchema = Joi.object({
  ...
  const onSubmitForm = async (data) =>{
    ...
    try {
      ...
      const body = data
      data.categoryId = JSON.stringify(category_id)

      const response = await fetch(`http://localhost:8080/companies/${company_id}`,
